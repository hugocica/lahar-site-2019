                    ...
                    <form id="email-form" name="email-form" data-name="Email Form" data-ix="show-on-scroll">
                        ...
                        <div class="w-row">
                            <div class="column-zero-pad w-col w-col-6">
                                ...
                                <input type="text" class="field w-input" maxlength="256" name="experimente-site" data-name="experimente-site" placeholder="Endereço do seu site*" id="experimente-site" required="" onblur="normalizaLink(this.value,this);">
                                ...
                                <div class="txt-14-white-small" data-ix="show-on-scroll">
                                    Clicando no botão abaixo você concorda com nossos <a href="contrato-de-prestacao-de-servicos.html" class="link-white">termos de uso</a>.<br>
                                </div>
                                <div class="spacer"></div>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#cria_conta_trial').click(function(e) {
                ...
                if ( email && nome && telefone && empresa && site && objetivo && validateEmail(email) ) {
                    ...
                    // url: 'http://localhost/site2018/enviar_trial.php',
                    dataType: 'json',
                    method: 'POST',
                    data: {
                        email: email,
