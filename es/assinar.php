...
<body>
        ...
        <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar alternativo w-nav">
            <div class="container-navbar noheader w-container">
                <a href="<?php echo base_url; ?>">
                    <img src="<?php echo base_url_assets ?>images/logo.png" width="143" class="logo-white">
                </a>
    ...
    <div id="formulario" class="div-padding-bottom">
        ...
        <div class="container-center w-container etapa-wrapper mensagem-final" data-etapa="4" style="display: none">
            <div class="mensagem_sucesso" style="display: none;">
                <img src="<?php echo base_url_assets ?>images/checked.png" width="60" height="60" class="checked">
            ...
            <div class="mensagem_erro" style="display: none;">
                <img src="<?php echo base_url_assets ?>images/close.svg" width="60" height="60" class="checked">
                <fieldset class="w-col w-col-9 center">
                    <h2 class="sucesso h1">
            ...
            <div data-animation="slide" data-hide-arrows="1" data-duration="500" data-infinite="1" class="slider-testimonials w-slider" data-ix="show-on-scroll">
                <div class="mask w-slider-mask">
                    <div class="slide-testimonial w-slide">
                        ...
                        <div class="spacer _50"></div><img src="<?php echo base_url_assets ?>images/fotoRafael.png" srcset="<?php echo base_url_assets ?>images/fotoRafael-p-500.png 500w, <?php echo base_url_assets ?>images/fotoRafael.png 816w" sizes="100px" class="foto-author">
                    ...
                    <div class="slide-testimonial w-slide">
                        ...
                        <div class="spacer _50"></div><img src="<?php echo base_url_assets ?>images/fotoKim.png" srcset="<?php echo base_url_assets ?>images/fotoKim-p-500.png 500w, <?php echo base_url_assets ?>images/fotoKim.png 762w" sizes="100px" class="foto-author">
                    ...
                    <div class="slide-testimonial w-slide">
                        ...
                        <div class="spacer _50"></div><img src="<?php echo base_url_assets ?>images/fotoMarina.png" srcset="<?php echo base_url_assets ?>images/fotoMarina-p-500.png 500w, <?php echo base_url_assets ?>images/fotoMarina.png 762w" sizes="100px" class="foto-author">
                    ...
                    <div class="slide-testimonial w-slide">
                        ...
                        <div class="spacer _50"></div><img src="<?php echo base_url_assets ?>images/fotoThiago.png" srcset="<?php echo base_url_assets ?>images/fotoThiago-p-500.png 500w, <?php echo base_url_assets ?>images/fotoThiago.png 654w" sizes="100px" class="foto-author">
                    ...
                    <div class="slide-testimonial w-slide">
                        ...
                        <div class="spacer _50"></div><img src="<?php echo base_url_assets ?>images/fotoRoberta.png" srcset="<?php echo base_url_assets ?>images/fotoRoberta-p-500.png 500w, <?php echo base_url_assets ?>images/fotoRoberta-p-800.png 800w, <?php echo base_url_assets ?>images/fotoRoberta.png 914w" sizes="100px" class="foto-author">
            ...
            <div class="container-assinatura w-container">
                <div class="w-row">
                    <div class="w-clearfix w-col w-col-6">
                        <div class="flags">
                            <a href="#"  onclick="changeLanguage('')" class="flag w-inline-block"><img src="<?php echo base_url_assets ?>images/brasil.svg"></a><div class="divider-flags"></div>
                            <a href="#"  onclick="changeLanguage('en')" class="flag w-inline-block"><img src="<?php echo base_url_assets ?>images/united-states.svg"></a>
    ...
    <script src="<?php echo base_url_assets ?>js/jquery.maskedinput.js"></script>
