    ...
    <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar-off home fixed w-nav">
        <div class="container-navbar w-container">
            ...
            <nav role="navigation" class="nav-menu-off w-clearfix w-nav-menu">
                ...
                </div><a href="https://blog.lahar.com.br/" target="_blank" class="link-nav w-nav-link">BLOG</a><a href="<?php echo base_url ?>criar-conta" class="link-nav cta w-nav-link">experimente grátis</a>
                <div class="flags">
                    ...
                    <a href="#" onclick="changeLanguage('en')"  class="flag w-inline-block">
                        <img src="<?php echo base_url_assets ?>images/united-states.svg">
                    </a>
                </div>
            </nav>
