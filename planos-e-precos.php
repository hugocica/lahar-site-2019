...
<head>
    <title>Automação de marketing digital: quanto custa? Veja aqui</title>
    <meta content="Saiba quanto custa a solução de automação de marketing digital da LAHAR, opções de planos e tabela de preços para cada tamanho de negócio." name="description">
    <meta content="Automação de marketing digital: quanto custa? Veja aqui" property="og:title">
    <meta content="Saiba quanto custa a solução de automação de marketing digital da LAHAR, opções de planos e tabela de preços para cada tamanho de negócio." property="og:description">
          ...
          <div class="w-container">
              <div class="w-row">
                  <div class="w-col w-col-6">
                      ...
                      <h1 class="h1" data-ix="show-on-scroll">Quanto custa fazer automação de Marketing Digital? Escolha o plano ideal para sua empresa</h1>
    ...
    <div class="section-branca">
          ...
          <div class="line-comparativo last buttons">
              <div class="container-comparativo w-container">
                  <div class="row-comparativo w-row" data-ix="show-on-scroll">
                      ...
                      <div class="coluna-icone-esquerda w-col w-col-2"><img src="assets/images/tick.svg" class="ico-check bottom">
                          <div class="txt-14 smaller center">Incluso no plano</div>
                      </div>
                      <div class="coluna-icone-esquerda w-col w-col-2"><img src="assets/images/close.svg" width="25" class="ico-close bottom">
                  ...
                  <div class="row-duvidas w-row" data-ix="show-on-scroll">
                      ...
                      <div class="w-col w-col-6"><img src="assets/images/phone-call.svg" width="50" class="phone">
          ...
          <div class="container-center w-container">
              ...
              <div class="titulos-padding" data-ix="show-on-scroll">
                  ...
                  <h2 class="h2 small blue">O que nossos clientes dizem sobre nosso software de automação de marketing:</h2>
              </div>
              <div class="spacer _50"></div>
        ...
        <div class="container-center w-container">
            ...
            <div class="w-row" data-ix="show-on-scroll">
                <div class="column-zero-pad w-col w-col-6">
                    <div>
                        ...
                        <div class="text-block-12">Período de trial</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Com a LAHAR você tem um período de até 15 dias de trial. Ou seja, você utiliza nosso software sem custo nenhum por até 15 dias.</div>
                    </div>
                </div>
                <div class="column-zero-pad w-col w-col-6">
                    <div class="div-block-15">
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Quais são as formas de pagamento aceitas?</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">A LAHAR aceita pagamento via cartão de crédito e boleto bancário. Para informações sobre o número de parcelas, contate nossa equipe negócios.</div>
                        <div class="spacer"></div>
            ...
            <div class="w-row" data-ix="show-on-scroll">
                <div class="column-zero-pad w-col w-col-6">
                    <div>
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Planos e diferenças</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">A LAHAR oferece 3 tipos de planos: Basic, Professional e Enterprise. A diferença entre eles reside em características como: número de subcontas, número de usuários, tipo de atendimento e funcionalidades do software. Todos os detalhes podem ser encontrados no comparativo acima entre os planos.</div>
                    </div>
                </div>
                <div class="column-zero-pad w-col w-col-6">
                    <div class="div-block-15">
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Pontos de contato pós contratação</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">A LAHAR possui uma equipe de Sucesso do Cliente focada em auxiliar nossos clientes tanto com questões tecnológicas quanto com estratégias para seu marketing digital. Nosso suporte funciona via Chat, Email e Skype, de segunda à sexta-feira, das 8h às 18h.</div>
                    </div>
                </div>
            </div>
            <div class="w-row" data-ix="show-on-scroll">
                <div class="column-zero-pad w-col w-col-6">
                    <div>
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Preciso de um desenvolvedor?</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Não. Para usar a LAHAR você não precisa de uma equipe altamente capacidade em desenvolvimento. Somos um software online, facilmente operado por sua equipe ou por você a partir de um login e senha. Nossa construção de emails é intuitiva a partir do modelador “arraste e solte”. Nossa interface é amigável para que consiga compreender o passo a passo. Além disso fornecemos login e senha para a Academia LAHAR, nosso EAD, que conta com uma série de vídeos explicativos sobre o software.</div>
                        <div class="spacer"></div>
                    </div>
                </div>
                <div class="column-zero-pad w-col w-col-6">
                    <div class="div-block-15">
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Migrando de planos</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Você pode fazer um upgrade de plano ou faixa de contato a hora que quiser. Para isso basta solicitar ao nosso atendimento.</div>
                    </div>
                </div>
            </div>
            <div class="w-row" data-ix="show-on-scroll">
                <div class="column-zero-pad w-col w-col-6">
                    <div>
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Quantas subcontas posso ter?</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Dependendo do seu tipo de plano o seu número de subcontas é definido. Por exemplo, no plano Basic você consegue ter 1 subconta, no plano Professional, até 10 subcontas. Já no plano Enterprise o número de subcontas é ilimitado.</div>
                    </div>
                </div>
                <div class="column-zero-pad w-col w-col-6">
                    <div class="div-block-15">
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Como cancelar minha assinatura?</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Para cancelar a sua assinatura basta entrar em contato com nossa equipe de atendimento. Caso você não tenha permanecido os 6 primeiros meses conosco haverá cobrança de uma taxa referente aos serviços prestados durante o período. Caso o cancelamento ocorra após este período, esta taxa não se aplica.</div>
                    </div>
                </div>
            </div>
            <div class="w-row" data-ix="show-on-scroll">
                <div class="column-zero-pad w-col w-col-6">
                    <div>
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Como contratar adicionais? (adicional de e-mail e sms)</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Para contratar pacotes de serviços adicionais, como mais envios de e-mails, ou sms, basta entrar em contato com a equipe de atendimento pelos meios de comunicação: chat, skype ou e-mail. Eles estarão sempre prontos para te ajudar.</div>
                    </div>
                </div>
                <div class="column-zero-pad w-col w-col-6">
                    <div class="div-block-15">
                        <div class="titles-14">GERAIS</div>
                        <div class="text-block-12">Como ter um apoio estratégico?</div>
                        <div class="spacer"></div>
                        <div class="txt-14 testimonial left">Nós oferecemos o serviço de implementação gratuita (setup) por 7 dias, a implementação rápida que dura 30 dias e implementação padrão que dura até 90 dias. Tanto a implementação rápida quanto a padrão são pagas e contam com diversas etapas que podem ser conferidas detalhadamente na nossa <a href="https://www.lahar.com.br/implementacao-lahar" target="_blank">página de implementação</a>.</div>
                    </div>
                </div>
            </div>
        </div>
